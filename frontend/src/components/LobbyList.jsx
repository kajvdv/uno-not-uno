...
export function LobbiesProvider({ children }) {
...
export function Modal({visible, onCancel, children}) {
    ...
    const formElements = (
        <>
            ...
            <div className="modal-buttons">
                <button className="create-form-button" type="button" onClick={onCancel}>Cancel</button>
...
function LobbyList({userName, onJoin}) {
    const lobbies = useContext(LobbiesContext);
            ...
            <div className="lobbies">
                <div id="lobby-list">
                    {lobbies.lobbies.map((lobby) => (
                        <Lobby key={lobby.id} {...lobby} user={userName} onJoin={onJoin} />
                    ))}
                </div>
            </div>
