...
async def test_crud_lobby(client: Client, user: str):
    name = 'test_lobby'
    size = 2
    ai_count = 0
...
async def test_lobby_already_exists(client, user):
    name = 'test_lobby'
    size = 2
    ai_count = 0
    response = await client.create_lobby(
...
async def test_cant_delete_other_user_lobby(client, user):
    name = 'test_lobby'
    size = 2
    ai_count = 0
    response = await client.create_lobby(
...
async def test_get_rules_lobby(client, user):
    name = 'test_lobby'
    size = 2
    ai_count = 0
    response = await client.create_lobby(
